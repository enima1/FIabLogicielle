...
public class ChercherDichoEtu {
	...
	public void test1ArticleExistant() {
		assertEquals(true, magasinTriee.chercherDichoEtu(art1));
	}

	@Test(timeout = 2000)
	public void test2ArticleExistant() {
		assertEquals(true, magasinTriee.chercherDichoEtu(art4));
	}

	@Test(timeout = 2000)
	public void test1ArticleInexistant() {
		Article artInexistant = new Article("inexistant", 42, 42);
		assertEquals(false, magasinTriee.chercherDichoEtu(artInexistant));
	}

	@Test
	public void testNull() {
		Article artNull = null;
		assertEquals(false, magasinTriee.chercherDichoEtu(artNull));
	}

	@Test(timeout = 2000)
	public void test1ArticleExistantNonTriee() {
		assertEquals(false, magasinTriee.chercherDichoEtu(art1));
	}

	@Test(timeout = 2000)
	public void test2ArticleExistantNonTriee() {
		assertEquals(false, magasinTriee.chercherDichoEtu(art4));
	}
}
