...
public class ChercherDicho2 {
	...
	public void test1ArticleExistant() {
		assertEquals(true, magasinTriee.chercherDicho2(art1));
	}

	@Test(timeout = 2000)
	public void test2ArticleExistant() {
		assertEquals(true, magasinTriee.chercherDicho2(art4));
	}

	@Test(timeout = 2000)
	public void test1ArticleInexistant() {
		Article artInexistant = new Article("inexistant", 42, 42);
		assertEquals(false, magasinTriee.chercherDicho2(artInexistant));
	}

	@Test
	public void testNull() {
		Article artNull = null;
		assertEquals(false, magasinTriee.chercherDicho2(artNull));
	}

	@Test(timeout = 2000)
	public void test1ArticleExistantNonTriee() {
		assertEquals(false, magasinTriee.chercherDicho2(art1));
	}

	@Test(timeout = 2000)
	public void test2ArticleExistantNonTriee() {
		assertEquals(false, magasinTriee.chercherDicho2(art4));
	}
}
