...
public class ChercherDicho5 {
	...
	public void test1ArticleExistant() {
		assertEquals(true, magasinTriee.chercherDicho5(art1));
	}

	@Test(timeout = 2000)
	public void test2ArticleExistant() {
		assertEquals(true, magasinTriee.chercherDicho5(art4));
	}

	@Test(timeout = 2000)
	public void test1ArticleInexistant() {
		Article artInexistant = new Article("inexistant", 42, 42);
		assertEquals(false, magasinTriee.chercherDicho5(artInexistant));
	}

	@Test
	public void testNull() {
		Article artNull = null;
		assertEquals(false, magasinTriee.chercherDicho5(artNull));
	}

	@Test(timeout = 2000)
	public void test1ArticleExistantNonTriee() {
		assertEquals(false, magasinTriee.chercherDicho5(art1));
	}

	@Test(timeout = 2000)
	public void test2ArticleExistantNonTriee() {
		assertEquals(false, magasinTriee.chercherDicho5(art4));
	}
}
